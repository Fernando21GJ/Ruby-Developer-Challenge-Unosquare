...
class RealEstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create real_estate" do
    assert_difference('RealEstate.count') do
      post real_estates_url, params: { real_estate: { bathrooms: @real_estate.bathrooms, city: @real_estate.city, comments: @real_estate.comments, country: @real_estate.country, external_number: @real_estate.external_number, internal_number: @real_estate.internal_number, name: @real_estate.name, neighborhood: @real_estate.neighborhood, rooms: @real_estate.rooms, street: @real_estate.street, string: @real_estate.string, type: @real_estate.type } }
    end
  ...
  test "should update real_estate" do
    patch real_estate_url(@real_estate), params: { real_estate: { bathrooms: @real_estate.bathrooms, city: @real_estate.city, comments: @real_estate.comments, country: @real_estate.country, external_number: @real_estate.external_number, internal_number: @real_estate.internal_number, name: @real_estate.name, neighborhood: @real_estate.neighborhood, rooms: @real_estate.rooms, street: @real_estate.street, string: @real_estate.string, type: @real_estate.type } }
